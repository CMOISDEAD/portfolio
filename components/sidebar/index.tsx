  ...
  return (
    <aside className="w-full border-b border-stone-200 dark:border-stone-700 bg-stone-100 dark:bg-stone-800 p-6 lg:sticky lg:top-0 lg:h-screen lg:w-72 lg:border-b-0 lg:border-r lg:p-8 xl:w-80">
      <motion.div
        ...
        className="flex gap-2 flex-col items-center justify-between lg:h-full"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          className="flex w-full flex-row items-center gap-4 lg:flex-col lg:items-center lg:gap-6"
        >
          ...
          <motion.div
            ...
            className="ml-auto flex flex-col gap-2 lg:ml-0 lg:mt-4 lg:w-full lg:pt-2"
          >
        ...
        <motion.div
          ...
          className="mt-8 hidden w-full space-y-6 sm:block lg:mt-0"
        >
          <Skills />
