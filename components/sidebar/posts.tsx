  ...
  return (
    <Card className="w-full bg-stone-400 dark:bg-stone-500 text-stone-700 dark:text-stone-300 shadow-md border border-stone-500 dark:border-stone-400">
      <CardContent className="p-4 flex flex-col items-start">
        <div className="w-full border-b border-stone-500 dark:border-stone-400 pb-2 mb-3">
        ...
        <Link
          ...
          className="mt-3 text-sm font-medium text-stone-900 dark:text-stone-100 hover:underline"
        >
          Read More →
        </Link>
      </CardContent>
